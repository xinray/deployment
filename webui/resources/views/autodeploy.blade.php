...
@section('js')
    <script type="text/javascript" src="{{ asset('static/js/autodeploy.js') }}"></script>
@stop
...
@section('content')
    <div class="container">
        ...
        <div class="first-line">
            <div class="left">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <tr>
                        <td class="productid" productid="{{ $item->productid }}">产品</td>
        ...
        <div class="second-line">
            <div class="test-result" data-config="{{ $config }}">
                <table class="table table-bordered table-striped table-hover ">
                    <thead>
                    <tr>
                        <th></th>
        ...
        <div class="third-line">
            ...
            <div class="deploy-process" >
                <table class="table table-bordered table-striped ">
                    ...
                    <tr>
                        <th>部署主机</th>
                        @foreach($jenkinsjob as $jenkins)
                            <th>{{ $jenkins['JenkinsJobNameCn'] }}</th>
                        @endforeach
                    </tr>
                    </thead>
                    ...
                    <tr>
                        ...
                        @foreach($jenkinsjob as $jenkinsresult)
